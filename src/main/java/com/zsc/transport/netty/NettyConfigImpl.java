package com.zsc.transport.netty;

import com.zsc.transport.exception.NullParamsException;
import com.zsc.transport.handler.AcceptorHandler;
import com.zsc.transport.handler.ProtocolDecoder;
import com.zsc.transport.handler.ProtocolDecoder1;
import com.zsc.transport.handler.ProtocolEncoder;
    ...
    public void setHandler() {
        ...
        bootstrap.childHandler(new ChannelInitializer<SocketChannel>() {
            ...
            protected void initChannel(SocketChannel ch) throws Exception {
                ...
                pipeline.addLast("ProtocolDecoder1", new ProtocolDecoder1());
